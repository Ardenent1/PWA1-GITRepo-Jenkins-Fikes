...
//player name
//Add 2nd player's name
//previous code: var playerOneName = "Spiderman";
//previous code: var playerTwoName = "Batman";
...
//player damage
//Decide the increments of damage done per round by the player
// Previous code: var player1Damage = 20;
//Previous code: var player2Damage = 20;

//player health
//Set the amount of health the player will start with at 100
//previous code: var playerOneHealth = 100;
//previous code: var playerTwoHealth = 100;

//initiate round
//Start playing the next round of the game
//keep track of the round
    var round=1; //Previous code held a "0"; define as a global variable for fighter rounds

//this function contains the code that loops through rounds and reduces the player’s health accordingly
    function fight(){
        console.log("In the fight function");
        alert(fighter1[0] + ":" + fighter1[2] + " *START* "+ fighter2[0] + ":" + fighter2[2]); //alert user to begin the fight

        for (var i = 0; i < 10; i++) //set FOR loop to keep it running through rounds
...
//check for winner
            ...
            if (result==="no winner") //if result in winnerCheck strictly equals variable of no winner, then code will loop and add another round
            {
                ...
                alert(fighter1[0] + ":" + fighter1[2] + "*ROUND " +round+" OVER" +"* "+ fighter2[0] + ":" + fighter2[2]); //alert the user that a new round is beginning
...
/*Previous wk 1 code for functions:
 //this function contains the code that loops through rounds and reduces the player’s health accordingly
 function fight(){
 console.log("In the fight function");
